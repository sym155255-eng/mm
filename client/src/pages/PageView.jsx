...
import { fetchPageView, fetchPublicData } from '../api';
...
export default function PageView() {
  ...
  useEffect(() => {
    let alive = true;
    setLoading(true);
    Promise.all([fetchPageView(id), fetchPublicData()]).then(([p, d]) => {
      if (!alive) return;
      setPage(p && !p.error ? p : null);
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={s.body}>
        ...
        <div style={s.card}>
          ...
          {page.content
            ? <div style={s.content} dangerouslySetInnerHTML={{ __html: page.content }} />
